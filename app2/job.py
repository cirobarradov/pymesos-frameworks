...
class Job(object):
    def __init__(self, dict, cmdVar=None):
        self.initFromDict(dict.get("name"),dict.get("num"),dict.get("tasks"),dict.get("cmd",cmdVar),dict.get("cpus",1.0),
...
class Task(object):
    ...
    def to_task_info(self, offer,
        ...
        ti.agent_id.value = offer.agent_id
